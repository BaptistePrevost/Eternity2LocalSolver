...
def solve_local_search(eternity_puzzle):
    ...
    #                         delta = -getBorderPieceConflicts(board1, board1[position1], position1)
    #                         delta -= getBorderPieceConflicts(board1, board1[position2], position2)
    #                         rotation1 = corner_rotation(board1[position2], position1)
    #                         delta += getBorderPieceConflicts(board1, rotation1, position1) 
    #                         delta += getBorderPieceConflicts(board1, board2[position2], position2)
    #                         if delta < bestDelta:
    #                             bestDelta = delta
    ...
    #                 else:
    #                     delta = -getInternalPieceConflicts(board1, board1[position2], position2)
    #                     if position1 != position2:
    #                         delta -= getInternalPieceConflicts(board1, board1[position1], position1)
    ...
    #                             conflicts1 = getInternalPieceConflicts(board1, board1[position1], position1)
    #                             conflicts2 = getInternalPieceConflicts(board1, board1[position2], position2)
    ...
    #                             bestMove = ((position1, _), (position2, board1[position2]))
    #                             # print("Internal move for a delta of ", bestDelta, "swapping" , position1, "with", position2)
    ...
    #                         delta = -getBorderPieceConflicts(board2, board2[position1], position1)
    #                         delta -= getBorderPieceConflicts(board2, board2[position2], position2)
    #                         rotation2 = corner_rotation(board2[position1], position2)
    #                         delta += getBorderPieceConflicts(board2, board1[position1], position1) 
    #                         delta += getBorderPieceConflicts(board2, rotation2, position2)
    #                         if delta < bestDelta:
    #                             bestDelta = delta
    ...
    #                 else:
    #                     delta = -getInternalPieceConflicts(board2, board2[position1], position2)
    #                     if position1 != position2:
    #                         delta -= getInternalPieceConflicts(board2, board2[position2], position2)
    ...
    #                             conflicts1 = getInternalPieceConflicts(board2, board2[position1], position1)
    #                             conflicts2 = getInternalPieceConflicts(board2, board2[position2], position2)
    #                             if delta + conflicts1 + conflicts2 < bestDelta:
    #                                 bestDelta = delta + conflicts1 + conflicts2
    #                                 bestMove = ((position1, board2[position1]), (position2, board2[position2]))
    #                                 # print("Internal move for a delta of ", bestDelta, "swapping" , position1, "with", position2)
    ...
    #                     else:
    #                         conflicts2 = getInternalPieceConflicts(board2, board2[position1], position1)
    #                         if delta + conflicts2 < bestDelta:
    #                             bestDelta = delta + conflicts2
    #                             bestMove = ((position1, board1[position1]), (position2, _))
    #                             # print("Internal move for a delta of ", bestDelta, "swapping" , position1, "with", position2)
    ...
    bestBoard = borderTabuSearch(board, MAX_BORDER_TABU_ITERATIONS, TABU_SIZE)
    allBestBoard = copy.deepcopy(bestBoard)
    allBestCost = eternity_puzzle.get_total_n_conflict(bestBoard)
    for _ in range(5):
        for _ in range(5):
            bestBoard = interiorTabuSearch(board, MAX_BORDER_TABU_ITERATIONS, TABU_SIZE, MAX_INTERIOR_NEIGHBORS)
            bestBoard = simulatedAnneallingStep(board, T0, MAX_INTERIOR_NEIGHBORS)
            if eternity_puzzle.get_total_n_conflict(bestBoard) < allBestCost:
                allBestCost = eternity_puzzle.get_total_n_conflict(bestBoard)
                allBestBoard = copy.deepcopy(bestBoard)
                print(f"(2) New best cost: {allBestCost}")
        bestBoard = perturbationStep(bestBoard, GAMMA)
        T0 *= ALPHA

    # print(getAllBorderConflicts(bestBoard))
    ...
    # for _ in range(10):
    #     board = fullyRandomConstruction()
    #     board = localSearch(board, 1000, fastBorderNeighborhoodSearch)
    #     board = localSearch(board, 1000, fastInteriorNeighborhoodSearch)
    ...
    #         # pool.add(bestBoard, bestCost)
    #         print(f"(1) New best cost: {bestCost}")
    ...
    #             board = pathRelinking(copy.deepcopy(elite1), copy.deepcopy(elite2))
    #             cost = eternity_puzzle.get_total_n_conflict(board)
    #             if cost < bestCost:
    #                 bestCost = cost
    #                 bestBoard = copy.deepcopy(board)
    ...
    return allBestBoard, eternity_puzzle.get_total_n_conflict(allBestBoard)
